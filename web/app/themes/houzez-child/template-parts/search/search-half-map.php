...
$housez_houzez_search_builder_first_row = houzez_search_builder_first_row() == '' ? 0 : houzez_search_builder_first_row();

$advanced_fields = array_slice($layout, $housez_houzez_search_builder_first_row);
?>
<section class="advanced-search advanced-search-half-map" data-dfdfd="fdfdfdf">

<?php showr(houzez_search_builder_first_row()) ?>
