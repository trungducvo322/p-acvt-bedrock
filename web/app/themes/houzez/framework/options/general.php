...
Redux::setSection( $houzez_opt_name, array(
    ...
    'fields'        => array(
        ...
        array(
            'id'       => 'backtotop',
            'type'     => 'switch',
            'title'    => esc_html__( 'Back to Top', 'houzez' ),
            'desc'     => '',
            'subtitle' => esc_html__( 'Show back to top button', 'houzez' ),
            'default'  => 1,
        ...
        array(
            'id'       => 'houzez_page_filters',
            'type'     => 'select',
            'multi'    => true,
            'title'    => esc_html__('Page Filters', 'houzez'),
            'subtitle' => esc_html__('Select which taxonomy filters you want to remove when add new page in admin panel.', 'houzez'),
            'options' => array(
                'property_type' => esc_html__('Types', 'houzez'),
                'property_status' => esc_html__('Statuses', 'houzez'),
                'property_city' => esc_html__('Cities', 'houzez'),
                'property_area' => esc_html__('Areas', 'houzez'),
                'property_states' => esc_html__('States', 'houzez'),
                'property_feature' => esc_html__('Features', 'houzez'),
                'property_label' => esc_html__('Labels', 'houzez')
            )
        ),
